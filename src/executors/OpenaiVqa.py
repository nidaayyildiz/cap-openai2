"""
OpenAI Executor: Answers a question about an image (Visual Question Answering).
"""
...
class OpenaiVqa(Capsule):
    ...
    def _build_messages(self, base64_image):
        ...
        system_instruction = (
            "You act as Visual Question Answering model. Answer the question about the image. "
        ...
        return [
            ...
            },
            {
                ...
                "content": [
                    ...
                    {
                        "type": "text",
                        "text": f"Question: {self.prompt}" if self.prompt else "Describe the image.",
                    },
                ],
            },
        ]
