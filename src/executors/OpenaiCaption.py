"""
OpenAI Executor: Generates a short caption for an image using the OpenAI vision API.
"""
...
class OpenaiCaption(Capsule):
    ...
    def _build_messages(self, base64_image):
        ...
        system_instruction = "You act as an image caption model. Provide a short description of the image."
        return [
            {
                "role": "system",
