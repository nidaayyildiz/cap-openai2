"""
OpenAI Executor: Performs OCR on an image using the OpenAI vision API.
"""
...
class OpenaiOcr(Capsule):
    ...
    def _build_messages(self, base64_image):
        ...
        system_instruction = (
            "You act as an OCR model. Read all text from the image and return it "
        ...
        return [
            ...
            },
            {
                ...
                "content": [
                    ...
                    {
                        "type": "text",
                        "text": self.prompt if self.prompt else "Read the text",
                    },
                ],
            },
        ]
