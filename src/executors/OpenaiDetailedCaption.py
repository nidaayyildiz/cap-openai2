"""
OpenAI Executor: Generates a detailed caption for an image using the OpenAI vision API.
"""
...
class OpenaiDetailedCaption(Capsule):
    ...
    def _build_messages(self, base64_image):
        ...
        system_instruction = "You act as an image caption model. Provide an extensive and detailed description of the image."
        return [
            {
                "role": "system",
